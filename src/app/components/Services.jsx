...
export default function Services() {
  ...
  <div className="card w-full h-full bg-base-100 shadow-xl flex flex-col">
    <figure>
    ...
    <div className="card-body flex flex-col justify-between">
      ...
      {/* See More Link */}
      <a href="#" className="text-blue-500 text-sm mt-1 hover:underline">See More</a>

      <div className="card-actions justify-end mt-auto">
        <button className="btn btn-primary">${service.price}</button>
      </div>
    </div>
  </div>
</div>
